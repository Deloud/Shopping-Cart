...
@Provider("ProductService2") // Set up name of tested provider
@PactFolder("../pacts") // Point where to find pacts (See also section Pacts source in documentation)

public class ConsumerProductTest {


    @State("product-cart test") // Method will be run before testing interactions that require "with-data" state
